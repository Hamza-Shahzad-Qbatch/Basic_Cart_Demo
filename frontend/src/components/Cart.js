...
function CartProduct(props) {
    ...
    const update_cart_prod_quantity = (val) => {
        const qty = (val === '' || val === '0') ? 1 : parseInt(val);
            ...
            <Grid
                ...
                <Grid item xs={3}>
                    ...
                    <input type='number'
                        ...
                        min='1'
                        onChange={(e) => update_cart_prod_quantity(e.target.value)} />
                </Grid>
                ...
                <Grid item xs={3}>
                    <p>
                        <label style={{
                            fontWeight: 'bolder',
                            color: 'turquoise'
                        }}>Price</label> : ${props.product.price}
                    </p>
                </Grid>

                <Grid item xs={3}>
                    <IconButton color='secondary'
                        onClick={() => delete_cart_prod(props.product.cart_id)}>
